...
public class Table  {
    ...
    public static String COMPONENT_ID = "rad.display.table";
    ...
    public static JsonSchema SCHEMA =
        JsonSchema.parse(RadComponents.class.getResourceAsStream("/radtable.props.json"));
    ...
    public static ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setName("React Table")
        .addPaletteEntry("", "React Table", "Custom React Table module.", null, null)
        .setDefaultMetaName("radTable")
